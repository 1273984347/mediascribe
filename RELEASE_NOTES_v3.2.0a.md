# MediaScribe v3.2.0a — Tier 2 Polish Release
...
[audio_utils.py](file:///d:/1/mediascribe/mediascribe/audio_utils.py) ·
[transcribers/chunked.py](file:///d:/1/mediascribe/mediascribe/transcribers/chunked.py)
...
20 new tests in
[test_vad_chunking.py](file:///d:/1/mediascribe/douyin_batch/tests/test_vad_chunking.py).

---

### 2. Cross-run persistent cache

[cache.py](file:///d:/1/mediascribe/mediascribe/cache.py)
...
|---|---|
| Linux | `$XDG_CACHE_HOME/mediascribe` (or `~/.cache/mediascribe`) |
| macOS | `~/Library/Caches/mediascribe` |
| Windows | `%LOCALAPPDATA%\mediascribe\cache` |

Override with the `MEDIASCRIBE_CACHE_DIR` environment variable.
...
```python
from mediascribe.cache import Cache
...
21 new tests in
[test_persistent_cache.py](file:///d:/1/mediascribe/douyin_batch/tests/test_persistent_cache.py)
...
[__main__.py](file:///d:/1/mediascribe/mediascribe/__main__.py) ·
[profile_cli.py](file:///d:/1/mediascribe/mediascribe/profile_cli.py)

`python -m mediascribe profile <run.jsonl>` aggregates pipeline
...
python -m mediascribe profile runs/2026-06-06.jsonl
...
26 new tests in
[test_profile_cli.py](file:///d:/1/mediascribe/douyin_batch/tests/test_profile_cli.py).

---

### 4. WebSocket real-time job progress

[progress.py](file:///d:/1/mediascribe/mediascribe/progress.py) ·
[web/app.py](file:///d:/1/mediascribe/mediascribe/web/app.py)
...
19 new tests across
[test_job_progress.py](file:///d:/1/mediascribe/douyin_batch/tests/test_job_progress.py)
and
[test_web_app_security.py](file:///d:/1/mediascribe/douyin_batch/tests/test_web_app_security.py)
...
[test_coverage_gaps_3.py](file:///d:/1/mediascribe/douyin_batch/tests/test_coverage_gaps_3.py)
...
|---|---:|---:|---:|
| `mediascribe/progress.py` | — | 100% | new |
| `mediascribe/cache.py` | 92% | 94% | +2 |
| `mediascribe/profile_cli.py` | 93% | 97% | +4 |
| `mediascribe/transcribers/chunked.py` | 89% | 89% | flat |
| `mediascribe/web/app.py` | 71% | 82% | +11 |
...
ruff check .                            # 0 errors
coverage report -m (mediascribe scope)   # 75% overall, all v3.2.0a modules ≥ 89%
```
...
pytest -q                      # 612 passed
python -m mediascribe --help    # transcribe / batch / profile sub-commands
```
...
- **Benchmark vs whisperx** — side-by-side WER + wall-clock on a
  ...
  [scripts/benchmark_transcribers.py](file:///d:/1/mediascribe/scripts/benchmark_transcribers.py).

See [docs_site/roadmap-v3.2.md](file:///d:/1/mediascribe/docs_site/roadmap-v3.2.md)
...
MIT — see [LICENSE](file:///d:/1/mediascribe/LICENSE).

## 🤝 Contributing

PRs welcome — see
[CONTRIBUTING.md](file:///d:/1/mediascribe/CONTRIBUTING.md) and
[CODE_OF_CONDUCT.md](file:///d:/1/mediascribe/CODE_OF_CONDUCT.md).
