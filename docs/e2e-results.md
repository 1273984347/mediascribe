...
The E2E suite is opt-in via `MEDIASCRIBE_E2E=1`. To capture real
...
python -m mediascribe --url "https://www.youtube.com/watch?v=xxx"
python -m mediascribe --url "https://mp.weixin.qq.com/s/xxx"
```
...
python -m mediascribe --url "https://mp.weixin.qq.com/s/IMAGE_ARTICLE_URL"
